...
persist_directory = 'C:/Users/user/Desktop/Lecture_Materials/GenerativeAI_Lecture/GenerativeAI_Practice/GAPR/chroma_store'
...
query_augmentation_prompt = ChatPromptTemplate.from_messages([
    ...
    (
        "system",
        "기존의 대화 내용을 활용하여 사용자가 질문한 의도를 파악해서 한 문장의 명료한 질문으로 변환하라. 대명사나 이, 저, 그와 같은 표현을 명확한 명사로 변환하라. :\n\n{query}",
    ),
])
